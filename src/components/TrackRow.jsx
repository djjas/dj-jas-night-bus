...
export default function TrackRow({ track, index, isPlaying, onPlay }) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`absolute left-[19px] sm:left-[27px] top-7 -translate-x-1/2 h-2.5 w-2.5 rounded-full border transition-colors duration-300 ${
          isPlaying
            ? "bg-sindoor border-sindoor"
            : "bg-night border-marigold/60 group-hover:border-marigold"
        }`}
        aria-hidden="true"
      />
